...
import requests
import cv2
from roboflow import get_model_endpoint, detect_parking_space, draw_boxes_and_count
...
st.set_page_config(
    ...
    menu_items={
        "Report a bug": "https://github.com/nothappenhere/object-detection-streamlit",
    ...
    if img is not None:
        ...
        with st.spinner("Running detection..."):
            if model_source == "Roboflow API":
                ...
                detected_image_path, counter = detect_with_local_model(
                    img, min_confidence
                )
